...
def list_drive_files(drive, folder_name):
    """
    List video files from the designated Google Drive folder.

    Args:
        drive: The Google Drive service object.
        folder_name: The name of the target folder.

    Returns:
        A list of dictionaries containing video file details.
    """
    try:
        # Get the folder ID based on the folder name
        folder_id = get_folder_id(drive, folder_name)
        # print('Folder id found',folder_id)
        # Check if the folder ID is found
        if folder_id:
            # Construct the query string to get video files from the specified folder
        ...
        print(f"An error occurred while listing video files: {str(e)}")
        return []
...
def get_folder_id(drive, folder_name):
    ...
    Returns:
        The ID of the folder or None if not found.
    """
    try:
        # Execute a query to get the folder ID
        ...
        print(f"An error occurred while getting folder ID: {str(e)}")
        return None
...
def initialize_upload():
    ...
    for file_id, title in zip(File_ids, File_names):
        ...
        print('Download sucessfull now uploading video >>>>>>>*****')
        tags = None
